            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="checkbox">
                            <!-- <input type='checkbox' name="roles[{{$role->id}}][]"  {{ (roleHasPermission($role->id,$permission->id)) ? "checked" : "" }} value='{{ $permission->id }}'> -->
                            <input type='checkbox' name="roles[{{$role->id}}][]"  {{ (roleHasPermission($role->id,$permission->id)) ? "checked" : "" }} value='{{ $permission->name }}'>
                              <!-- {!! Form::checkbox("roles[{$role->id}][]", $permission->id , $permission->name) !!}    -->
